        ...
        <div class="swiper-wrapper">
            <?php foreach($arResult['BANNERS']['ADDITIONAL'] as $banner): ?>
              <div class="swiper-slide header-banner-item" data-swiper-autoplay="<?=$banner['autoplay']?>">
                  ...
                  <?php else: ?>
                        <?if ($banner['form']) { ?>
                            <?if($banner['form']=="services") {?>
                                <a href="" data-services="yes" data-event="jqm" data-param-form_id="ZAPIS" data-name="cheaper"><img src="<?=$banner['picture']['src']?>" class="header-banner-item__picture" alt="" /></a>
                            <?} elseif($banner['form']=="traid") {?>
                                <a href="" data-traid="yes" data-event="jqm" data-param-form_id="TRADE_IN" data-name="cheaper"><img src="<?=$banner['picture']['src']?>" class="header-banner-item__picture" alt="" /></a>
                            <?}?>
                        <?} else {?>
                                <img src="<?=$banner['picture']['src']?>" class="header-banner-item__picture" alt="" />
                        <?}?>
