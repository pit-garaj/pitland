	...
	BX.Sale.OrderAjaxComponent = {
		...
		showWarnings: function()
		{
			...
			if (currentDelivery && currentDelivery.CALCULATE_ERRORS)
			{
				...
				if ( this.params.MESS_DELIVERY_CALC_ERROR_TITLE == 'Не удалось рассчитать стоимость доставки.' )
				{
					this.params.MESS_DELIVERY_CALC_ERROR_TEXT = 'Уточняйте по телефону: +7 (495) 363 52 99, +7 (968) 998 46 12';
				}
