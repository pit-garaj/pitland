		...
		<div class="bx_filter_section">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
                ...
                if($arItem['CODE'] == "BRAND"){
                    $this->SetViewTarget("filter_brand");
                    ...
                    <div class="bx_filter_block <?=($arItem["PROPERTY_TYPE"]!="N" && ($arItem["DISPLAY_TYPE"] != "P" && $arItem["DISPLAY_TYPE"] != "R") ? "limited_block" : "");?>" <?=$style;?>>
                        ...
                        $isHidden = true;?>
                            <div class="hidden_values">
                                ...
                                />
                                <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_brand_label <?=($isSize ? "nab sku" : "");?> <?=($i==$count ? "last" : "");?> <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
