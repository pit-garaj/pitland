    ...
    <div class="bx_filter bx_filter_vertical">
        <div class="bx_filter_section">
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                  method="get" class="smartfilter" id="smartfilter<?= $arParams['AJAX_FILTER_FLAG']; ?>">
                                        ...
                                        <div class="wrapp_all_inputs wrap_md">
                                            ...
                                            <div class="wrapp_slider iblock">
                                                <div class="bx_ui_slider_track" id="drag_track_<?= $key ?>">
                                                    ...
                                                    <div class="bx_ui_slider_part first p1"><span><?= $value1 ?></span>
                                                    </div>
                                                    ...
                                                    <div class="bx_ui_slider_part last p5"><span><?= $value5 ?></span>
                                                    </div>
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if ($arItem['CODE'] == "BRAND") {
                        ...
                        ob_start();
                        {
                            ...
                            if (isset($_REQUEST["ajax_get_filter"])):?> js_filter_tmp <? endif; ?> <?= $class; ?>"
                                 data-expanded="<?= ($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N"); ?>"
                                 data-prop_code=<?= strtolower($arItem["CODE"]); ?> data-property_id="<?= $arItem["ID"] ?>">
                                <span class="bx_filter_container_modef"></span>
                                <?= $isAjax; ?>
                                ...
                                if ($arItem["CODE"] != "IN_STOCK") {
                                    ?>
                                    <div class="bx_filter_parameters_box_title icons_fa" style="display:none;">
                                        <div>
                                            <?= ($arItem["CODE"] == "MINIMUM_PRICE" ? Loc::getMessage("PRICE") : $arItem["NAME"]); ?>
                                            <div class="char_name">
                                                <div class="props_list">
                                ...
                                <div class="bx_filter_block <?= ($arItem["PROPERTY_TYPE"] != "N" && ($arItem["DISPLAY_TYPE"] != "P" && $arItem["DISPLAY_TYPE"] != "R") ? "limited_block" : ""); ?>" <?= $style; ?>>
                                    <div class="bx_filter_parameters_box_container <?= ($arItem["DISPLAY_TYPE"] == "G" ? "pict_block" : ""); ?>" style="text-align: center;">
                                        <?
                                        $arCur = current($arItem["VALUES"]);
                                        $count = count($arItem["VALUES"]);
                                        $i = 1;
                                    ...
                                    $isHidden = true; ?>
                                        <div class="hidden_values">
                                            ...
                                            />
                                            <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
                                                   class="bx_filter_brand_label <?= ($isSize ? "nab sku" : ""); ?> <?= ($i == $count ? "last" : ""); ?> <? echo $ar["DISABLED"] ? 'disabled' : '' ?>"
                                                   for="<? echo $ar["CONTROL_ID"] ?>">
											<span class="bx_filter_input_checkbox">
												<span class="bx_filter_brand_img" title="<?= $ar["VALUE"]; ?>">
                                                    <?
                                                    if ($ar['IMG']):?>
                                                        <img src="<?= $ar['IMG'] ?>">
                                                        <? //else:
                                        ...
                                        <div class="inner_expand_text" style="display:none;"><span
                                                    class="expand_block"><?= Loc::getMessage("FILTER_EXPAND_VALUES"); ?></span>
                                        </div>
                                    <?
                                    endif;
                            ...
                            <?
                            $GLOBALS['BREND_FILTER'] = ob_get_contents();
                        }
                        ob_end_clean();
                        ...
                        <div class="bx_filter_block">
                            <div class="bx_filter_parameters_box_container">
                                <div class="bx_filter_popup_result right"
                                    ...
                                    <a rel="nofollow" href="<? echo $arResult["FILTER_URL"] ?>"
