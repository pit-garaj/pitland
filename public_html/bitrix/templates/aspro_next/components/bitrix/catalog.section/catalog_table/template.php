								...
								<tr>
									<td class="foto-cell">
										<div class="image_wrapper_block">
											...
											<?/*
											<div class="fast_view_block icons" data-event="jqm" data-param-form_id="fast_view" data-param-iblock_id="<?=$arParams["IBLOCK_ID"];?>" data-param-id="<?=$arItem["ID"];?>" data-param-item_href="<?=urlencode($arItem["DETAIL_PAGE_URL"]);?>" data-name="fast_view">
                    ...
                    <div class="catalog-item-availability">
                      <span class="catalog-item-availability_<?=$arItem['AVAILABILITY']['availability_style']?>"><?=$arItem['AVAILABILITY']['availability']?></span>
									...
									if ( $APPLICATION->GetCurDir() == '/catalog/tekhnika/pitbayki/' )
									{
										...
										$arAddToBasketData['HTML'] .= '<br /><button style="margin-top: 10px;" data-item="' . $arItem['ID'] . '" data-iblockid="23" data-quantity="1" onclick="oneClickBuy(' . $arItem['ID'] . ', 23, this )"><span class="small btn btn-default transition_bg animate-load">Купить в 1 клик</span></button>';
									}
									?>
									...
									<td class="price-cell">
										<div class="cost prices clearfix">
											...
											<?
											if ( strpos( $arQuantityData['HTML'], 'Есть в наличии' ) || !strpos( $arItem['DETAIL_PAGE_URL'], '/tekhnika/' ) )
											{
											?>
