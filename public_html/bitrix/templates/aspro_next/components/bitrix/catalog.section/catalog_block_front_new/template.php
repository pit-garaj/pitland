...
<div class="tab_slider_wrapp specials  s_IrdTaW best_block clearfix new_blocks" itemscope itemtype="http://schema.org/WebPage">
	<?if($page=="/new/" or $page=="/new/index.php") {} else {?>
		<div class="top_blocks">
			<ul class="tabs ajax">
				<li data-code="DISCOUNT" class="cur clicked"><span>Новинки</span><a href="/new/" style="margin-left: 42px; font-size: 15px;">Смотреть все</a></li>
				<li class="stretch"></li>
			</ul>
		</div>
	<?}?>
	<ul class="tabs_content" <?if($page=="/new/" or $page=="/new/index.php") {?>style="margin-top:0px;"<?}?>>
		<li class="tab STOCK_wrapp cur opacity1" data-code="STOCK" data-col="3">
