...
<div class="tab_slider_wrapp specials  s_IrdTaW best_block clearfix new_blocks" itemscope itemtype="http://schema.org/WebPage">

	<div class="top_blocks">
		<ul class="tabs ajax">
			<li data-code="DISCOUNT" class="cur clicked"><span class="new_name">Новинки</span><a href="/new/" style="margin-left: 42px; font-size: 15px;">Смотреть все</a></li>
			<li class="stretch"></li>
		</ul>
	</div>

	<div class="center-slick-slideder">
			...
			<div class="catalog_item_wrapp col-lg-<?=$col;?> col-md-4 col-sm-<?=floor(12 / round($arParams['LINE_ELEMENT_COUNT'] / 2))?> item" data-col="<?=$col;?>">
						...
						<div class="image_wrapper_block shine">
							...
							<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb">
								...
								<?elseif( !empty($arItem["DETAIL_PICTURE"])):?>
									<?$img = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array( "width" => 290, "height" => 170 ), BX_RESIZE_IMAGE_PROPORTIONAL,true );?>
							...
							<?/*
											<div class="fast_view_block" data-event="jqm" data-param-form_id="fast_view" data-param-iblock_id="<?=$arParams["IBLOCK_ID"];?>" data-param-id="<?=$arItem["ID"];?>" data-param-item_href="<?=urlencode($arItem["DETAIL_PAGE_URL"]);?>" data-name="fast_view">
												<button><?=$fast_view_text;?></button>
											</div>
											*/?>
			...
			<div class="bottom_block_item">
				<div class="bottom_block_item_left">
					<div class="compare_item_button">
						<span class="compare_item to" data-iblock="<?=$arParams["IBLOCK_ID"]?>" data-item="<?=$arItem["ID"]?>">Добавить к сравнению</span>
						<span class="compare_item in added" style="display: none;"  data-iblock="<?=$arParams["IBLOCK_ID"]?>" data-item="<?=$arItem["ID"]?>">Удалить из сравнения</span>
					</div>
				</div>
				<a class="bottom_block_item_right" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
					Подробнее
				</a>
			</div>
