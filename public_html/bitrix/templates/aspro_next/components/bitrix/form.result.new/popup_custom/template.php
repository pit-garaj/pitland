...
<div class="form <?=$arResult["arForm"]["SID"]?> form_cnt_custom">
	<a href="#" class="close jqmClose"><i></i></a>
	<!--noindex-->
	<?if(!empty($arResult["arForm"]["IMAGE_ID"])) {?>
		<div class="form_head" style="background: url(<?=CFile::GetPath($arResult["arForm"]["IMAGE_ID"])?>);">
		</div>
	<?}?>
		...
		<div class="form_footer">
			...
			<?if($bShowLicenses == "Y"):?>
				<div class="licence_block filter label_block">
					...
					<? if($arResult["arForm"]["SID"] == "TRADE_IN") {?>
						<div><a class="more-about-service" href="/services/servis/" target="_blank">Подробнее о Сервисе</div>
					<?}?>
				</div>
			<?endif;?>
