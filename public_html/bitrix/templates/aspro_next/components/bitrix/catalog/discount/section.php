...
if ( $_REQUEST['FROM_POPUP'] == 'Y' )
{
	...
	?>
		<img src="/upload/popup_result.png" alt="" style="width: 100%; height: auto"/>
		<br /><br />
...
<?
if ( $arResult['VARIABLES']['SECTION_ID'] && !$arResult['VARIABLES']['SMART_FILTER_PATH'] && false )
{
	$APPLICATION->IncludeComponent(
		'ownedmuhaha:section.seo.links',
		'',
		Array(
