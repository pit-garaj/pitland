...
if (($item['PREVIEW_PICTURE']['ID'] != 0) || ($item['PREVIEW_PICTURE_SECOND']['ID'] != 0) ) {
    $renderImage = CFile::ResizeImageGet($item['PREVIEW_PICTURE']["ID"], Array("width" => "300", "height" => "300"), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false);
    $renderImage2 = CFile::ResizeImageGet($item['PREVIEW_PICTURE_SECOND']["ID"], Array("width" => "300", "height" => "300"), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false);
    $item['PREVIEW_PICTURE']['SRC'] = $renderImage[src];
    $item['PREVIEW_PICTURE_SECOND']['SRC'] = $renderImage2[src];
}
?>
					...
					<div class="product-item-info-container product-item-price-container" data-entity="price-block">
						...
						<span class="product-item-price-current" id="<?=$itemIds['PRICE']?>">
							...
							if (!empty($price))
							{
								...
								{
									echo str_replace("руб.", "<i class='fa fa-rub' aria-hidden='true'></i>", Loc::getMessage(
								...
								{
									echo str_replace("руб.", "<i class='fa fa-rub' style='font-size: 19px;' aria-hidden='true'></i>", $price['PRINT_RATIO_PRICE'] );
								}
							}
							?>
						</span>
					...
					<div class="product-item-info-container product-item-hidden" data-entity="buttons-block">
						...
						if (!$haveOffers)
						{
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<a class="btn btn-pbl <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
										href="javascript:void(0)" rel="nofollow">
							...
							else
							{
								...
								<div class="product-item-button-container">
									...
									?>
									<a class="btn btn-pbl <?=$buttonSizeClass?>"
						...
						else
						{
							...
							else
							{
								?>
								<div class="product-item-button-container">
									<a class="btn btn-pbl <?=$buttonSizeClass?>" href="<?=$item['DETAIL_PAGE_URL']?>">
