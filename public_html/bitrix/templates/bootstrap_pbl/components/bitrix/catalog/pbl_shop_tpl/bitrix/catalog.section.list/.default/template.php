	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="col-xs-4 col-sm-3 col-md-2">
				<a
					href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
					...
					if ($arParams["COUNT_ELEMENTS"])
					{
						?> <span class="treygol"><span><? echo $arSection['ELEMENT_CNT']; ?></span></span><?
					}?>
