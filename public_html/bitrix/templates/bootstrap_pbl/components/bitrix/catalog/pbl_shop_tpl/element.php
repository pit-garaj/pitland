			...
			if (!empty($recommendedData))
			{
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
                    ...
                    <script language="JavaScript">
                        if (document.body.clientWidth > '1366') {
                            $.ajax({
                                method: "POST",
                                url: "/bitrix/templates/bootstrap_pbl/components/bitrix/catalog/pbl_shop_tpl/bitrix/ajax/popularsect_6_item.php",
                                data: {arResult :<?=CUtil::PhpToJSObject($arResult)?>, arParams :<?=CUtil::PhpToJSObject($arParams)?>},
                            }).done(function( html ) {
                                $( "#popular_product" ).html( html );
                            });
                        }
                    </script>
                ...
                <script language="JavaScript">
                    if (document.body.clientWidth > '1366') {
                        $.ajax({
                            method: "POST",
                            url: "/bitrix/templates/bootstrap_pbl/components/bitrix/catalog/pbl_shop_tpl/bitrix/ajax/viewed_6_item.php",
                            data: <?=CUtil::PhpToJSObject($arParams)?>,
                        }).done(function( html ) {
                            $( "#viewed_product" ).html( html );
                        });
                    }
                </script>
					<div class='col-xs-12' data-entity="parent-container">
