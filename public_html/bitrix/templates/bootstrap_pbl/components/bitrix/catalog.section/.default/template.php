...
<div class="row catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
...
if ($showLazyLoad)
{
	?>
	<div class="row">
		<div class="btn btn-default btn-lg center-block" style="clear: both;display:grid;margin: 15px;border-radius:0px;background:black;color:white;"
