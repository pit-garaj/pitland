...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		...
		<?endif?>
	<?else:?>
			<li class="bx-pag-prev" style="display:none;"><span><?echo GetMessage("round_nav_back")?></span></li>
	...
	<?else:?>
		...
		<?endif?>
			<li class="bx-pag-next" style="display:none;"><span><?echo GetMessage("round_nav_forward")?></span></li>
	<?endif?>
