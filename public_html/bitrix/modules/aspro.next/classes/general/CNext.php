...
class CNext{
	...
	public static function Start($siteID){
		...
		if(CModule::IncludeModuleEx(self::moduleID) == 1)
		{
			...
			$APPLICATION->SetPageProperty('viewport', 'initial-scale=1.0, width=device-width, user-scalable=no');
			...
			$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/jquery.maskedinput-1.2.2.min.js');
