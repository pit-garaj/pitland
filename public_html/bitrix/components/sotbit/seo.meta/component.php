...
if (is_array($results)) {
    ...
    foreach ($results as $result) {
        ...
        if (isset($result['TITLE']) && !empty($result['TITLE'])) {
            $sotbitSeoMetaTitle = Engine::process($sku, $result['TITLE']);
            ...
            if (!empty($arParams['CITY'])) {
                $sotbitSeoMetaTitle = Seo::modifySeoText($sotbitSeoMetaTitle, $arParams['CITY']);
            }
        ...
        if (isset($result['KEYWORDS']) && !empty($result['KEYWORDS'])) {
            $sotbitSeoMetaKeywords = Engine::process($sku, $result['KEYWORDS']);

            if (!empty($arParams['CITY'])) {
                $sotbitSeoMetaKeywords = Seo::modifySeoText($sotbitSeoMetaKeywords, $arParams['CITY']);
            }
        ...
        if (isset($result['DESCRIPTION']) && !empty($result['DESCRIPTION'])) {
            $sotbitSeoMetaDescription = Engine::process($sku, $result['DESCRIPTION']);
            ...
            if (!empty($arParams['CITY'])) {
                $sotbitSeoMetaDescription = Seo::modifySeoText($sotbitSeoMetaDescription, $arParams['CITY']);
            }
        ...
        if (isset($result['PAGE_TITLE']) && !empty($result['PAGE_TITLE'])) {
            $sotbitSeoMetaH1 = Engine::process($sku, $result['PAGE_TITLE']);
            ...
            if (!empty($arParams['CITY'])) {
                $sotbitSeoMetaH1 = Seo::modifySeoText($sotbitSeoMetaH1, $arParams['CITY']);
            }
        ...
        if (isset($result['BREADCRUMB_TITLE']) && !empty($result['BREADCRUMB_TITLE'])) {
            ...
            $sotbitSeoMetaBreadcrumbTitle = Engine::process($sku, $result['BREADCRUMB_TITLE']);
        ...
        if (isset($result['ELEMENT_TOP_DESC']) && !empty($result['ELEMENT_TOP_DESC'])) {
            $sotbitSeoMetaTopDesc = Engine::process($sku, html_entity_decode($result['ELEMENT_TOP_DESC']));
        ...
        if (isset($result['ELEMENT_BOTTOM_DESC']) && !empty($result['ELEMENT_BOTTOM_DESC'])) {
            $sotbitSeoMetaBottomDesc = Engine::process($sku, html_entity_decode($result['ELEMENT_BOTTOM_DESC']));
        ...
        if (isset($result['ELEMENT_ADD_DESC']) && !empty($result['ELEMENT_ADD_DESC'])) {
            $sotbitSeoMetaAddDesc = Engine::process($sku, html_entity_decode($result['ELEMENT_ADD_DESC']));
