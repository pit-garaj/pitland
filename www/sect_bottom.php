...
<div class="row">
	<div class="bx-content col-xs-12">
		...
		<?endif?>
		<br/>
		<h2 style="padding-left: 14px;padding-left: 14px;text-transform: uppercase;font-weight: bold;font-size: 40px;">Новости</h2>
		<?$APPLICATION->IncludeComponent("bitrix:news.list", "home_news", Array(
