    ...
    <div class="right_info">
        <div class="info_item">
			...
			<div class="quantity_block_wrapper">
				<?if($useStores){?><div class="p_block"><?}?>
				<?=$arQuantityData["HTML"];?>
				<?if($useStores){?></div><?}?>

				<? /* if($arParams["SHOW_CHEAPER_FORM"] == "Y"):?>
					<div class="cheaper_form"><span class="animate-load" data-event="jqm" data-param-form_id="CHEAPER" data-name="cheaper" data-autoload-product_name="<?=CNext::formatJsName($arResult["NAME"]);?>" data-autoload-product_id="<?=$arResult["ID"];?>">Хочу дешевле</span></div>
				<?endif; */ ?>
			</div>
            ...
            <div class="row catItemsBtn">
	            ...
	            <div class="col-md-6">
		            <div class="counter_wrapp">
						<a href="javascript:;" class="btn btn-default in-cart btn-lg type_block transition_bg one_click ownd-credit-button">
            ...
            <div class="row catItemsBtn">
	            ...
	            <div class="col-md-6">
		            <div class="counter_wrapp">
						<a href="" class="btn btn-default white btn-lg type_block transition_bg one_click" data-event="jqm" data-param-form_id="CHEAPER" data-name="cheaper" data-autoload-product_name="<?=CNext::formatJsName($arResult["NAME"]);?>" data-autoload-product_id="<?=$arResult["ID"];?>">
            ...
            <div class="catItemsFeatures">
	            <div class="catItemsFeatures__item icon delivery">Бесплатная доставка по России</div>
	            ...
	            <div class="catItemsFeatures__item catItemsFeatures__logos">
		            <div class="catItemsFeatures__logo"><img src="<?=SITE_TEMPLATE_PATH?>/images/delivery/pek.png" /></div>
		            <div class="catItemsFeatures__logo"><img src="<?=SITE_TEMPLATE_PATH?>/images/delivery/dl.png" /></div>
		            <div class="catItemsFeatures__logo"><img src="<?=SITE_TEMPLATE_PATH?>/images/delivery/energy.png" /></div>
		            <div class="catItemsFeatures__logo"><img src="<?=SITE_TEMPLATE_PATH?>/images/delivery/pochta.png" /></div>
		            <div class="catItemsFeatures__logo"><img src="<?=SITE_TEMPLATE_PATH?>/images/delivery/grastin.png" /></div>
	            </div>
            </div>

			<div class="catItemsStores">
        ...
        <div class="ask_a_question_wrapper">
            <div class="ask_a_question">
                ...
                <div class="outer">
	                ...
	                <span><span class="btn btn-default btn-lg white" onclick="jivo_api.open({start: 'call'});"><span><?=(strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : GetMessage('S_ASK_QUESTION'))?></span></span></span>
