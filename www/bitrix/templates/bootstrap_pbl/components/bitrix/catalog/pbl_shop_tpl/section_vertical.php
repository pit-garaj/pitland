...
if ($isFilter || $isSidebar): ?>
	<div class="col-sm-4 col-md-3 col-lg-2 <?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
...
<?endif?>
<div class="<?=(($isFilter || $isSidebar) ? "col-sm-8 col-md-9 col-lg-10" : "col-xs-12")?>">
	<div class="row">
		<div class="col-xs-12">
			<?
