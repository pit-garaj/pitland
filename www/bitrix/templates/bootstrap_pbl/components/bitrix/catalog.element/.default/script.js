	...
	window.JCCatalogElement.prototype = {
		...
		setPrice: function()
		{
			...
			if (this.obPrice.price)
			{
				if (price)
				{
					BX.adjust(this.obPrice.price, {html: BX.Currency.currencyFormat(price.RATIO_PRICE, price.CURRENCY, true).replace("руб.", "<i class='fa fa-rub' aria-hidden='true'></i>")});
...
$('.price-block').prependTo( $('.product-item-detail-pay-block') );
